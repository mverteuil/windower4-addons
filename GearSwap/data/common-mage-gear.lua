...
function magegear.init_mage_gear()
	...
	-- Staff Declarations
	sets.Staves = {}
	sets.Staves.Damage = { main="Wayfarer Staff" }
	sets.Staves.Accuracy = { main="Wayfarer Staff" }
...
function magegear.build_default_sets()
	...
	sets.Engaged.Melee = set_combine(sets.Haste, { main="Eminent Staff", sub="Axe Grip", ear1="Bladeborn Earring", ear2=MoonshadeEarring, ring1="Rajas Ring", ring2="Sun Ring", back="Buquwik Cape" })
